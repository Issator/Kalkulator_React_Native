...
export default class DistanceView extends React.Component{
  ...
  // TODO 
  calculateResult = () => {
    let result = parseFloat(this.state.fromPicker) * this.state.fromValue / parseFloat(this.state.toPicker)
        ...
        <View style={{ flex: 4}}>
          ...
          <View style={styles.row}>
            <View style={styles.flexOneCenter}>
              <DistancePicker valPicker={this.state.fromPicker} changeValPicker={this.updatefromPicker}/>
            </View>
            <View style={styles.flexOneCenter}>
          ...
          <View style={styles.row}>
            <View style={styles.flexOneCenter}>
              <DistancePicker valPicker={this.state.toPicker} changeValPicker={this.updatetoPicker}/>
            </View>
            <View style={styles.flexOneCenter}>
